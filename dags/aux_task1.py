...
#SALVANDO ARQUIVOS ESTRUTURADOS
...
#TRANSFERINDO ARQUIVOS PARA OUTRA PASTA
def copiar_arquivos(data='26-01-2025', diretorio_origem = './data_extracted', diretorio_destino = './data_tube'):
